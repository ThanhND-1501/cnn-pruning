...
class PruneResNet50(PruneBase):
    def __init__(self, weights_dict, **prune_args):
        super(PruneResNet50, self).__init__(weights_dict, **prune_args)
        self.merge_all = prune_args["merge_all"]
        self.block_nums = 4  # ResNet50 has 4 stages
        self.image_size = prune_args.get("image_size", [224, 224])  # Default for ImageNet
